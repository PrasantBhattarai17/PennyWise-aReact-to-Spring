    ...
    <div className="grid grid-cols-10 h-20 border-b-2 shadow-sm ">
      ...
      <div className="col-span-7 flex">
        <div className="  w-2/3 flex items-center justify-center  ">
          <input
            className="border-y-2 border-l-2 w-[80%] h-12  px-4 rounded-l-3xl border-[blueviolet]  "
            placeholder="Search"
          />
       ...
       <FontAwesomeIcon className="text-3xl m-auto" icon={faBell}/>
       <div className="w-3/4 flex justify-between">
        <img className="w-16 h-16 m-auto" src="https://avatars.githubusercontent.com/u/122468711?v=4"/>
